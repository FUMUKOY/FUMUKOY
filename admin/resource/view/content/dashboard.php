					...
					<div class="panel">
						<div class="panel-body">
							...
							<div class="text-center" style="padding-bottom: 10px;">
								...
								<h5 class="designation"> Semi-Stack web developer </h5>
							</div>
					...
					<div class="panel">
						<div class="panel-body">
							<div style="margin-bottom: 10px;">
								<a class="btn p-follow-btn" href="mailto:consumer@tebelloyarona.co.za"> 
									<i class="fa fa-envelope"></i> &nbsp; consumer@tebelloyarona.co.za 
								</a>
							</div>
							<div style="margin-bottom: 10px;">
								<a class="btn p-follow-btn" href="callto:+27839425145" style="margin-right: 8px;"> 
									<i class="fa fa-phone"></i> &nbsp; +27839425145
								</a>
						...
						<div class="carousel slide auto panel-body" id="c-slide">
							...
							<div class="carousel-inner">
								 <!-- <div class="item text-center active">
									<h3> Moclean| ONLINE SHOPPING STORE </h3>
									<p> Website </p>
									<p class="text-muted">
										Moclean is an eCommerce web-application.
									</p>
								</div>
								<div class="item text-center">
									<h3> Moclean| ONLINE SHOPPING STORE </h3>
									<p> Backendd Development </p>
									<p class="text-muted">
										It uses php for the backend and MySQL
									</p>
								</div>
								<div class="item text-center">
									<h3> Moclean| ONLINE SHOPPING STORE </h3>
