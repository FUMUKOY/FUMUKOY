...
<html lang="en">
	<head>
		...
		<title>Admin Login | Moclean </title>
		
		<!--=*= CSS FILES SOURCE START =*=-->
		<link rel="shortcut icon" href="../public/assets/images/favicon/Moclen_logo.jpg" type="image/png">
		...
		<div class="container">
			<form class="form-signin" method="post" action="">
				<div class="form-signin-heading text-center">
					...
					<img class="disable" src="../public/assets/images/favicon/Moclen_logo.jpg" alt="" style="height: 126px;"/>
				</div>
				<div class="login-wrap">
					<input name="username" type="email" class="form-control" placeholder="Email ID" >
					<input name="password" type="password" class="form-control" placeholder="Password" >
					<button name="try_login" class="btn btn-lg btn-infoo btn-block" type="submit">
