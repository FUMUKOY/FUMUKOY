						...
						<div class="row">
							...
							<div class="col-lg-3 col-md-6">
								<div class="widget">
									...
									<p>Moclean's infrastructure is manipulate with MVC Pattern and it's developed in a Raw PHP project. </p>
									<p> 
										<li> HTML5, CSS3 </li>
							...
							<div class="col-lg-4 col-md-6">
								<div class="widget">
									<ul class="contact-info">
										<li><span class="contact-info-label">Address:</span>03 Kudua sreet,carlletonville,2499</li>
										<li><span class="contact-info-label">Phone:</span>Toll Free <a href="tel:">(+27) 083 942 5145</a></li>
										<li><span class="contact-info-label">Email:</span> <a href="mailto:mail@example.com">consumer@tebelloyarona.co.za</a></li>
				...
				<div class="container">
					<div class="footer-bottom">
						<p class="footer-copyright mt-1">All Rights Reserved &copy; <?= date('Y') ?> | Developed By 
							<a href="#" target="_blank"> Group 7</a>
						</p>
						...
						<div class="social-icons">
							<a href="https://www.facebook.com/MocleanDetergents/" class="social-icon" target="_blank">
								<i class="icon-facebook"></i>
							</a>
							<a href="https://www.linkedin.com/in/felicia-nombeko-dlabongo-45b24121b/" class="social-icon" target="_blank">
				...
				<div class="modal-content">
					<div class="cuspop" style="background-image: url('public/assets/images/menu-bg.png')">
						...
						<div class="modal-body">
							...
							<p>Subscribe to the <b> MocleanOnline Shopping</b>  newsletter <br/> to receive timely updates from your favorite products.</p>
							<form action="" method="post">
								<div class="row">
