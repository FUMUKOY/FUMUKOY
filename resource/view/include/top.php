...
<html lang="en">
	<head>
		...
		<meta name="author" content="Moclean">
		<title> Moclean | <?php echo $pageTitle ?> </title>
		
		<link rel="icon" type="image/icon" href="public/assets/images/favicon/Moclen_logo.jpg">
				...
				<div class="header-top">
					<div class="container">
						<div class="header-left header-dropdowns">
							...
							<div class="header-dropdown">
								<a href="#"><img src="public/assets/images/favicon/SA_flag.png" alt="South African flag">South Africa</a>
								<!-- <div class="header-menu">
									<ul>
					...
					<div class="container">
						<div class="header-left">
							<a href="index.php" class="logo">
								<img style="height: 60px;" src="public/assets/images/favicon/Moclen_logo.jpg" alt="MocleanLogo">
							</a>
						</div>
							...
							<form action="search.php" method="post" style="margin-bottom: -8px;">
								<div class="input-group" style="width: 100%; margin: 0px 60px;">
									...
									<div class="input-group-append">
										<button class="btn btn-sm btn-info" type="submit"><i class="icon-magnifier"></i> SEARCH </button>
									</div>
						...
						<div class="header-right">
							...
							<div class="header-contact"><span>Call us now</span>
								<a href="tel:#"><strong>+27 839425145</strong></a>
							</div>
