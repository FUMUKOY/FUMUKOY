		...
		<div class="container">
			<div class="text-center printClose">
				<ul class="checkout-progress-bar">
					<li><span>Orders & Delivery</span></li>	
				...
				<div class="col-md-12">
						...
						<div class="row">
							<div class="col-md-3 col-xs-2">
								<div class="invoice-title">
									<h1>invoice</h1>
									<img class="logo-print" src="public/assets/images/favicon/logo.png" alt="" style="width: 220px; height: 100px;">
								</div>
							</div>
					...
					<div class="row">
						<div class="col-md-8 col-xs-7 payment-method">
							...
							<p>1. Cash on Delivery(Check).</p>
							<p>2. Payment via Card (Work in Progress).</p>
							<p>3. Paypal Integration work in progress.</p>
					...
					<div class="col-md-12">
						...
						<div class="row">
							<div class="col-md-8 col-xs-7 payment-method">
								...
								<p style="font-style: normal; font-size: 17px;" class="inv-label mt-1 mb-2"> 
									<span style="color: orange; font-weight: bold;">IN AMOUNT: </span>
									<?php echo $getAmount->inAwords($getdetailsResult[0]['grand_total']) ; ?>
								</p>
								<h3 class="inv-label itatic">Thank you for your business</h3>
							</div>
							<div class="col-md-4 col-xs-5 invoice-block pull-right">
