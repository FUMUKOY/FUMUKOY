							...
							<div class="entry-body">
								...
								<div class="entry-content">
									<p class="text-justify" style="font-size: 14px;">
										Please provide all your details clear and consice, disclamer that payments send to the wrong
										account Moclean will not be held liable. 
									</p>
								</div>
							</div>
						</article>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header bg-warning">
				<h2 class="modal-title text-light" id="exampleModalLabel">Edit Delivery Address</h2>
