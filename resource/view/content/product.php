			...
			<aside class="sidebar-product col-lg-3 padding-left-lg mobile-sidebar">
				<div class="sidebar-wrapper">
					<div class="widget widget-brand">
						<a href="#">
							<img src="public/assets/images/favicon/Moclen_logo.jpg" alt="brand name" style="height: 86px; width: 76px;">
						</a>
					</div>
					<div class="widget widget-info">
						<ul>
							<li>
								...
								<h4>FREE Delivery<br>FOR RETURN <br>PRODUCTS </h4>
							</li>
							<li>
								<i class="icon-us-dollar"></i>
								<h4>10% MONEY<br>BACK <br>GUARANTEE</h4>
							</li>
							<li>
								<i class="icon-online-support"></i>
								<h4>ONLINE Support<br>During Buiness<br> Hours.</h4>
							</li>
						</ul>
					</div>
