					...
					<form action="" method="post">
						<div class="input-group">
							<select class="form-control" name="shipping_method">
								...
								<option value="50"> Inside Gauteng </option>
								<option value="120"> Outside Gauteng</option>
							</select>
							<div class="input-group-append">
								<button name="fob" class="btn btn-sm btn-info" type="submit">Confirm Delivery</button>
							</div>
						</div>
					</form>
				</div>
