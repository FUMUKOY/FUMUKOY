	...
	<nav aria-label="breadcrumb" class="breadcrumb-nav mb-2">
		<div class="container">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active" aria-current="page">Orders & Delivery</li>
			</ol>
		</div>
	</nav>
	<div class="container">
			...
			<div class="col-lg-12">
				<div class="text-center">
					<ul class="checkout-progress-bar">
						<li class="active"><span>Orders & Delivery</span></li>	
				...
				<?php
					...
					if(isset($_POST['submit_order']))
					{
						...
						<div class="d-flex justify-content-center">
							<img src="public/assets/images/purchase-order-success.svg" alt="" class="img-fluid">
						</div>
					...
					else if(isset($_POST['customerRegistration']))
					{
						...
						<div class="alert alert-success alert-dismissible fade show" role="alert">
							...
							Please <b> Login </b> and submit your Delivery Address details.
							<button type="button" class="close" data-dismiss="alert" aria-label="Close">
								<span aria-hidden="true">&times;</span>
							</button>
						</div>';
			...
			<div class="col-lg-12">
				<div class="row">
					...
					<div class="col-lg-5 offset-lg-2">
						<ul class="checkout-steps">
							<li>
								<h2 class="step-title mb-2">Delivery Address</h2>
								<form action="payments.php" method="post">
									...
									<div class="form-group">
										<label>Country</label>
										<input type="text" name="shipadd_cntry" class="form-control" value="Midrand">
									</div>
									<div class="form-group required-field">
