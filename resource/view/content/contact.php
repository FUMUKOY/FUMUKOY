...
<main class="main">
	...
	<div class="container">
		...
		<div class="map">
			...
			<script type="text/javascript" src="http://maps.google.com/maps/api/js?key=AIzaSyB5r2ReOiNO61o56SioGyKEaKlpQys7v6Y&amp;callback=initMap"></script> 
			...
			<div>
			<a href="https://www.google.com/maps/dir//MOCLEAN,+43+Botha+St,+Oberholzer,+Carletonville,+2499/@-26.3468654,27.373666,17z/data=!4m8!4m7!1m0!1m5!1m1!1s0x1e95c5df841bca1b:0xbf3a4602a29ea8dc!2m2!1d27.3758547!2d-26.3468702" class="partner">
					<img src="public/assets/images/Moclean_map.png" alt="moclean map">
				</a>
			</div>
			...
			<div class="col-md-4">
				...
				<div class="contact-info">
					...
					<div>
						...
						<p><a href="mailto:#">consumer@tebelloyarona.co.za</a></p>
						<p>Email</p>
					</div>
